		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#listenanzeige-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"listenanzeige-display": {
								"semanticObject": "listenanzeige",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=listenanzeige",
									"url": sap.ui.require.toUrl("listenanzeige")
								}
							}
						}
					}
